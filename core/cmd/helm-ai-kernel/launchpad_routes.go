...
func handleLaunchpadMCPApproval(w http.ResponseWriter, _ *http.Request) {
	// Launchpad receives opaque request metadata only. It must not mint a
	// receipt-shaped value or mark a server executable until a credential
	// verifier is wired to the governing approval authority.
