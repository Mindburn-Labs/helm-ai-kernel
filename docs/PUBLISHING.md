...
| Python SDK | `helm-sdk` |
| Rust SDK | `helm-sdk` |
| Java SDK | Maven Central coordinate `io.github.mindburnlabs:helm-sdk:0.5.17` |
| Go SDK | `github.com/Mindburn-Labs/helm-ai-kernel/sdk/go@v0.5.17`; publish with the subdirectory tag `sdk/go/v0.5.17` |
...
Release target: `v0.5.17`. The release is complete only after the tagged
...
<https://github.com/Mindburn-Labs/helm-ai-kernel/releases/tag/v0.5.17>.
...
- `SHA256SUMS.txt`
- `sbom.json`
- `v0.5.17.openvex.json`
- `release-attestation.json`
- `evidence-pack.tar`
- `release.high_risk.v3.toml`
- `sample-policy-material.tar`
- `helm-ai-kernel-launchpad-data.tar`
- `helm-console-web-v0.5.17.tar.gz`
- `helm-console-web-v0.5.17.tar.gz.sha256`
- `helm-console-web-v0.5.17.tar.gz.sbom.spdx.json`
- `helm-console-web-v0.5.17.tar.gz.provenance.json`
- `helm-console-web-v0.5.17.tar.gz.lock.json`
- `helm-console-web-v0.5.17.tar.gz.manifest.json`
- `helm-ai-kernel.mcpb`
- `helm-ai-kernel.rb`
- `v0.5.17.json`
...
`helm-ai-kernel.rb` formula asset for version `0.5.17` and publishes the same
...
For `v0.5.16`, use `SHA256SUMS.txt`, `sbom.json`, `v0.5.17.openvex.json`,
