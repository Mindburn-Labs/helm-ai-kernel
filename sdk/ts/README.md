...
Package metadata declares version `0.5.8` in `package.json`; this README does
...
`0.5.8` is the release-hardening patch with the retained OpenAPI client surface and protobuf message bindings.
