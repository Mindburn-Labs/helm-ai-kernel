...
Package metadata declares crate version `0.5.7` in `Cargo.toml`; verify registry
...
`0.5.7` is the release-hardening patch with the retained OpenAPI client surface and optional protobuf codegen.
