...
Release target: `v0.5.10`. The release is complete only after the tagged
...
`helm-ai-kernel.rb` formula asset for version `0.5.10` and publishes the same
...
For `v0.5.10`, use `SHA256SUMS.txt`, `sbom.json`, `v0.5.10.openvex.json`,
