...
- Canonical role: Public HELM AI Kernel implementation: fail-closed execution kernel, CLI/API, SDK/contracts, receipts, replay/conformance surfaces, and local OSS Console quickstart host for a verified app-helm-console web bundle.
...
- Claim evidence: `core/cmd/helm-ai-kernel`, `core/pkg/guardian`, `core/pkg/receipt`, `core/pkg/evidence/externalhost`, `core/pkg/correlation/hostaction`, `core/pkg/verifier/externalreceipt`, `api/openapi`, `Dockerfile`, `charts/helm-ai-kernel`, `README.md`, `scripts/release/stage_console_bundle.sh`.
