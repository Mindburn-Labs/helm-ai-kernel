...
/// AuthorizedExecutionIntent : Signed executable intent. `signature_schema = helm.execution.intent.signature.v2` binds every authorization-relevant field below; an absent schema is a legacy audit-only intent and cannot authorize execution.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct AuthorizedExecutionIntent {
    ...
    #[serde(rename = "effect_digest_hash", skip_serializing_if = "Option::is_none")]
    ...
    pub signature_schema: Option<AuthorizedExecutionIntentSignatureSchema>,
    #[serde(rename = "signature_type", skip_serializing_if = "Option::is_none")]
    pub signature_type: Option<String>,
    #[serde(rename = "allowed_tool", skip_serializing_if = "Option::is_none")]
    pub allowed_tool: Option<String>,
    #[serde(rename = "taint", skip_serializing_if = "Option::is_none")]
    pub taint: Option<Vec<String>>,
    #[serde(rename = "emergency_activation_id", skip_serializing_if = "Option::is_none")]
    pub emergency_activation_id: Option<String>,
    #[serde(rename = "emergency_delegation_session_id", skip_serializing_if = "Option::is_none")]
    pub emergency_delegation_session_id: Option<String>,
    #[serde(rename = "emergency_scope_hash", skip_serializing_if = "Option::is_none")]
    pub emergency_scope_hash: Option<String>,
}
...
impl AuthorizedExecutionIntent {
    ...
    pub fn new() -> AuthorizedExecutionIntent {
        AuthorizedExecutionIntent {
            ...
            allowed_tool: None,
            taint: None,
            emergency_activation_id: None,
            emergency_delegation_session_id: None,
            emergency_scope_hash: None,
        }
    }
}
///
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum AuthorizedExecutionIntentSignatureSchema {
    #[serde(rename = "helm.execution.intent.signature.v2")]
    HelmPeriodExecutionPeriodIntentPeriodSignaturePeriodV2,
}

impl Default for AuthorizedExecutionIntentSignatureSchema {
    fn default() -> AuthorizedExecutionIntentSignatureSchema {
        Self::HelmPeriodExecutionPeriodIntentPeriodSignaturePeriodV2
    }
}
...
/// DecisionInterventionMetadata : Temporal-guardian metadata included in the signed v2 decision envelope when present.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
...
/// DecisionRecord : Signed policy decision. For `signature_schema = helm.decision.signature.v2`, every semantic decision field except `input_context` and `signature` is part of the canonical signing envelope. The signature is the result of signing that envelope and is therefore not part of its own preimage. Clients that need independent verification must preserve all fields shown here.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DecisionRecord {
    ...
    #[serde(rename = "state_cursor", skip_serializing_if = "Option::is_none")]
    pub state_cursor: Option<String>,
    #[serde(rename = "snapshot", skip_serializing_if = "Option::is_none")]
    pub snapshot: Option<String>,
    #[serde(rename = "env_fingerprint", skip_serializing_if = "Option::is_none")]
    ...
    pub input_context: Option<std::collections::HashMap<String, serde_json::Value>>,
    ...
    pub intervention: Option<Box<DecisionInterventionMetadata>>,
}
...
pub struct DecisionRequest {
    ...
    #[serde(rename = "session_history", skip_serializing_if = "Option::is_none")]
    pub session_history: Option<Vec<SessionAction>>,
}
...
pub struct Receipt {
    ...
    #[serde(rename = "external_reference_id", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "effect_type", skip_serializing_if = "Option::is_none")]
    pub effect_type: Option<String>,
    #[serde(rename = "tool_fingerprint", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "signature_schema", skip_serializing_if = "Option::is_none")]
    pub signature_schema: Option<ReceiptSignatureSchema>,
    ...
    #[serde(rename = "emergency_scope_hash", skip_serializing_if = "Option::is_none")]
    pub emergency_scope_hash: Option<String>,
    #[serde(rename = "safe_dep_state", skip_serializing_if = "Option::is_none")]
    pub safe_dep_state: Option<String>,
    #[serde(rename = "safe_dep_reason_code", skip_serializing_if = "Option::is_none")]
    pub safe_dep_reason_code: Option<String>,
    #[serde(rename = "network_log_ref", skip_serializing_if = "Option::is_none")]
    pub network_log_ref: Option<String>,
    #[serde(rename = "secret_events_ref", skip_serializing_if = "Option::is_none")]
    pub secret_events_ref: Option<String>,
    #[serde(rename = "sandbox_lease_id", skip_serializing_if = "Option::is_none")]
    pub sandbox_lease_id: Option<String>,
    #[serde(rename = "effect_graph_node_id", skip_serializing_if = "Option::is_none")]
    pub effect_graph_node_id: Option<String>,
    #[serde(rename = "port_exposures", skip_serializing_if = "Option::is_none")]
    pub port_exposures: Option<Vec<std::collections::HashMap<String, serde_json::Value>>>,
    #[serde(rename = "replay_script", skip_serializing_if = "Option::is_none")]
    pub replay_script: Option<std::collections::HashMap<String, serde_json::Value>>,
    #[serde(rename = "provenance", skip_serializing_if = "Option::is_none")]
    pub provenance: Option<std::collections::HashMap<String, serde_json::Value>>,
    #[serde(rename = "bundled_artifacts", skip_serializing_if = "Option::is_none")]
    pub bundled_artifacts: Option<Vec<std::collections::HashMap<String, serde_json::Value>>>,
    #[serde(rename = "transparency", skip_serializing_if = "Option::is_none")]
    pub transparency: Option<std::collections::HashMap<String, serde_json::Value>>,
    #[serde(rename = "log_id", skip_serializing_if = "Option::is_none")]
    pub log_id: Option<String>,
    #[serde(rename = "leaf_index", skip_serializing_if = "Option::is_none")]
...
impl Receipt {
    pub fn new() -> Receipt {
        Receipt {
            ...
            emergency_scope_hash: None,
            safe_dep_state: None,
            safe_dep_reason_code: None,
            network_log_ref: None,
            secret_events_ref: None,
            sandbox_lease_id: None,
            effect_graph_node_id: None,
            port_exposures: None,
            replay_script: None,
            provenance: None,
...
/// Present on newly-issued receipts whose SafeDep and evidence authority fields are bound by the v2 canonical payload.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum ReceiptSignatureSchema {
    #[serde(rename = "helm.receipt.signature.v2")]
    HelmPeriodReceiptPeriodSignaturePeriodV2,
}

impl Default for ReceiptSignatureSchema {
    fn default() -> ReceiptSignatureSchema {
        Self::HelmPeriodReceiptPeriodSignaturePeriodV2
    }
}
/// Receipt signature profile emitted by the signer. Classical is Ed25519-only; hybrid is Ed25519 plus ML-DSA-65.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
...
pub struct SessionAction {
    ...
    pub resource: String,
    #[serde(rename = "verdict")]
    pub verdict: SessionActionVerdict,
...
impl SessionAction {
    pub fn new(action: String, resource: String, verdict: SessionActionVerdict, timestamp: i64) -> SessionAction {
        SessionAction {
            action,
            resource,
            verdict,
...
impl Default for SessionActionVerdict {
    fn default() -> SessionActionVerdict {
        Self::Allow
    }
}
