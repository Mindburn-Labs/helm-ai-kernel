...
The current public GitHub release is `v0.5.9`. Its
...
`v0.5.9.openvex.json`, `release-attestation.json`, `evidence-pack.tar`,
...
`make release-assets` stages the `v0.5.9` asset set under
