# OpenClaw HELM Reference Proof Pack

This reference pack contains deterministic, offline-verifiable fixtures for OpenClaw on the
...
EvidencePack are specific to OpenClaw (`app_id: openclaw`, and this pack's `evidence-pack.tar`
