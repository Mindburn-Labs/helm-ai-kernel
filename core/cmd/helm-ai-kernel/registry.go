...
func completionContexts() []completionContext {
	return expandCompletionContexts([]completionContext{
		...
		{Path: []string{"setup"}, Candidates: []string{"claude-code", "codex", "hermes", "status", "repair", "remove", "--client", "--print-config", "--json", "--quickstart", "--profile", "claude", "codex", "mcp", "openai-compatible", "--yes", "--dry-run", "--data-dir", "--console", "--console-port", "--no-open", "--offline", "--reset"}},
		...
		{Path: []string{"setup", "remove"}, Candidates: []string{"claude-code", "codex", "hermes", "--scope", "user", "project", "--workspace", "--yes", "--dry-run", "--json", "--data-dir"}},
		{Path: []string{"setup", "repair"}, Candidates: []string{"claude-code", "codex", "hermes", "--scope", "user", "project", "--workspace", "--yes", "--dry-run", "--json", "--data-dir"}},
		{Path: []string{"setup", "status"}, Candidates: []string{"claude-code", "codex", "hermes", "--scope", "user", "project", "--workspace", "--json", "--data-dir"}},
