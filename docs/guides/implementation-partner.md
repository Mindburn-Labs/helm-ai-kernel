...
This guide packages the local, self-hosted HELM AI Kernel v0.9.0 source target for an
...
The expected source release target for this packet is `0.9.0`. This is not a
...
[v0.9.0 release](https://github.com/Mindburn-Labs/helm-ai-kernel/releases/tag/v0.9.0).
