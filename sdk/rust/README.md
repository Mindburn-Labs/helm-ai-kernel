...
Package metadata declares crate version `0.5.17` in `Cargo.toml`; verify registry
...
`0.5.17` is the release-hardening patch with the retained OpenAPI client surface and optional protobuf codegen.
