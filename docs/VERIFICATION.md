...
Current source release target: `v0.5.15`:
<https://github.com/Mindburn-Labs/helm-ai-kernel/releases/tag/v0.5.15>. The
release is complete only when the page attaches platform binaries,
`SHA256SUMS.txt`, `sbom.json`, `v0.5.15.openvex.json`,
`release-attestation.json`, `evidence-pack.tar`,
`release.high_risk.v3.toml`, `sample-policy-material.tar`,
`helm-ai-kernel-launchpad-data.tar`, `helm-console-web-v0.5.15.tar.gz`,
its checksum/SBOM/provenance/lock/manifest sidecars, `helm-ai-kernel.mcpb`,
`helm-ai-kernel.rb`, `v0.5.15.json`, `version-status.json`, and matching
...
## v0.5.15 Asset Contract

The `v0.5.15` release is complete only when it attaches these primary assets:
...
- `SHA256SUMS.txt`
- `sbom.json`
- `v0.5.15.openvex.json`
- `release-attestation.json`
- `evidence-pack.tar`
- `release.high_risk.v3.toml`
- `sample-policy-material.tar`
- `helm-ai-kernel-launchpad-data.tar`
- `helm-console-web-v0.5.15.tar.gz`
- `helm-console-web-v0.5.15.tar.gz.sha256`
- `helm-console-web-v0.5.15.tar.gz.sbom.spdx.json`
- `helm-console-web-v0.5.15.tar.gz.provenance.json`
- `helm-console-web-v0.5.15.tar.gz.lock.json`
- `helm-console-web-v0.5.15.tar.gz.manifest.json`
- `helm-ai-kernel.mcpb`
- `helm-ai-kernel.rb`
