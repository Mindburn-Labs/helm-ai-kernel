...
`io.github.mindburnlabs:helm-sdk:0.5.18`. Remote Maven resolution and repo1
...
`0.5.18` is the release-hardening patch with the retained OpenAPI client surface
