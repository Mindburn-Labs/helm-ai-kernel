# Kilo Code HELM Reference Proof Pack

This reference pack contains deterministic, offline-verifiable fixtures for Kilo Code on the
...
EvidencePack are specific to Kilo Code (`app_id: kilocode`, and this pack's `evidence-pack.tar`
