...
// VerifyModulePolicy checks if the new module complies with System Rules AND its own Policy.
func (e *CELPolicyEvaluator) VerifyModulePolicy(ctx context.Context, newModule ModuleBundle) error {
	// 1. Prepare Input
