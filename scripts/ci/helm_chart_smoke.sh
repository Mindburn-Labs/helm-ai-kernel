...
assert_contains "$rendered" "-test-connection"
assert_contains "$rendered" "app.kubernetes.io/component: test"
assert_contains "$rendered" "helm.sh/hook: test"
assert_contains "$rendered" "helm.sh/hook-delete-policy: before-hook-creation"
assert_contains "$rendered" "helm.ai/test-intent: \"kernel health\""
assert_contains "$rendered" "ttlSecondsAfterFinished: 300"
assert_contains "$rendered" "probing kernel health at"
