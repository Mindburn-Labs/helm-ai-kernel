...
func (stubBudget) Check(string, BudgetCost) (bool, error) { return true, nil }
func (stubBudget) Consume(string, BudgetCost) error       { return nil }

func TestStress_OptionWithBudgetTracker(t *testing.T) {
	g := newTestGuardian(t, WithBudgetTracker(stubBudget{}))
	if g.tracker == nil {
