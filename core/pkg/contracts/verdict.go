...
// Wire format: an open JSON string field "reason_code" in DecisionRecord.
//
// The registry, protocols/json-schemas/reason-codes/reason-codes-v1.json, is
// the only list of codes. CoreReasonCodes (reason_codes_gen.go) is generated
// from it; the constants below are the kernel's names for those values, and
