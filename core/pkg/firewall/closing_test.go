...
type closingFakeDispatcher struct{ called int }

func (s *closingFakeDispatcher) Dispatch(_ context.Context, _ string, _ map[string]any) (any, error) {
	s.called++
	return "ok", nil
}
...
func TestClosing_Firewall_AllowedTools(t *testing.T) {
	...
	fake := &closingFakeDispatcher{}
	fw := NewPolicyFirewall(fake)
