...
HELM_URL=http://127.0.0.1:7715 HELM_ADMIN_API_KEY=local-admin-key HELM_TENANT_ID=default HELM_PRINCIPAL_ID=local-demo-agent HELM_WORKSPACE_ID=default node examples/ts_sdk/dist/main.js
```
