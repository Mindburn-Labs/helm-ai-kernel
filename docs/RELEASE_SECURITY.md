...
<!-- quantum_posture: security release docs mention existing cosign and EvidencePack verification only; this page adds no post-quantum cryptographic control. -->
...
`helm-ai-kernel.mcpb`, `helm-ai-kernel.rb`, `v0.5.19.json`,
