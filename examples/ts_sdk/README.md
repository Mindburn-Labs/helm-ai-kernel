...
HELM_URL=http://127.0.0.1:7715 HELM_ADMIN_API_KEY=local-admin-key HELM_TENANT_ID=local-demo HELM_PRINCIPAL_ID=local-demo-principal node examples/ts_sdk/dist/main.js
```
