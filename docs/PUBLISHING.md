...
| Python SDK | `helm-sdk` |
| Rust SDK | `helm-sdk` |
| Java SDK | Maven Central coordinate `io.github.mindburnlabs:helm-sdk:0.7.0` |
| Go SDK | `github.com/Mindburn-Labs/helm-ai-kernel/sdk/go@v0.7.0`; publish with the subdirectory tag `sdk/go/v0.7.0` |
...
- Go SDK subdirectory tag publication for `sdk/go/v0.7.0`
...
Release target: `v0.7.0`. The release is complete only after the tagged
...
<https://github.com/Mindburn-Labs/helm-ai-kernel/releases/tag/v0.7.0>.
...
The retained release workflow attaches a `helm-ai-kernel.rb` formula asset for version `0.7.0`
...
`v0.7.0.openvex.json`, `release-attestation.json`, the platform binary assets,
