...
Package metadata declares crate version `0.7.0` in `Cargo.toml`; verify registry
...
`0.7.0` is the release-hardening patch with the retained OpenAPI client surface and optional protobuf codegen.
