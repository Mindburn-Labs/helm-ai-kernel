...
type GateRequest struct {
	...
	// Intent is a read-only authority snapshot supplied by the executor. Gate
	// implementations return runtime activation evidence through GateResult;
	// they must never populate or mutate signature-bound intent fields.
