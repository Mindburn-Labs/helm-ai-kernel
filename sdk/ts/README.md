...
Package metadata declares version `0.6.0` in `package.json`; this README does
...
`0.6.0` is the release-hardening patch with the retained OpenAPI client surface and protobuf message bindings.
