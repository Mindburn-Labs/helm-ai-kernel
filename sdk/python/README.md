...
Package metadata declares version `0.7.3` in `pyproject.toml`; this README does
...
`0.7.3` is the release-hardening patch with the retained OpenAPI client surface and local test coverage.
