...
| Developer code intelligence | [DeusData/codebase-memory-mcp](https://github.com/DeusData/codebase-memory-mcp) | Local read/query graph intelligence for HELM source review; side-effecting MCP tools still route through HELM governance. |
