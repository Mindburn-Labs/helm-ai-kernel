...
<!-- quantum_posture: launch preview receipts and certification records use
classical Ed25519 only; this specification makes no hybrid or post-quantum claim. -->
...
The envelope and receipt schemas published with this preview are wire contracts,
not a live verifier or connector path. Cryptographic verification, permit
consumption, receipt signing, and Go/Python vector parity are separate required
producer slices before any launch effect can be promoted.
