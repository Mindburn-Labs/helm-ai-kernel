...
func TestEngineRegisterGatePreservesOrder(t *testing.T) {
	e := NewEngine()
	e.RegisterGate(&fakeGate{id: "GA", name: "Alpha"})
	e.RegisterGate(&fakeGate{id: "GB", name: "Beta"})
...
func TestEngineRegisterDuplicateDoesNotDuplicateOrder(t *testing.T) {
	e := NewEngine()
	e.RegisterGate(&fakeGate{id: "GA", name: "v1"})
	e.RegisterGate(&fakeGate{id: "GA", name: "v2"})
