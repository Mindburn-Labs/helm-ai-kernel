...
coordinate `io.github.mindburnlabs:helm-sdk:0.7.3`. This source target does not
...
`0.7.3` is the release-hardening patch with the retained OpenAPI client surface
