 ...
 * Why this exists:
 *
 * The generated {@link TypesGen} class contains 6 TODO comments at lines
 * 6203, 6229, 6751, 6777, 8226, 8252 noting: "there is no validation against
 * JSON schema constraints". The code generator emits deserialization logic
 * but skips schema-level constraints (min/max, enum membership, regex
 * pattern, required fields) during discriminated-union {@code oneOf}
 * matching. This means a malformed payload can deserialize to the wrong
