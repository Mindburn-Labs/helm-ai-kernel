...
Release target: `v0.5.13`. The release is complete only after the tagged
...
The `v0.5.13` release attaches a
`helm-ai-kernel.rb` formula asset for version `0.5.13` and publishes the same
...
For `v0.5.13`, use `SHA256SUMS.txt`, `sbom.json`, `v0.5.13.openvex.json`,
