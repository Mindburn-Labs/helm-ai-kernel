...
| Python SDK | `helm-sdk` |
| Rust SDK | `helm-sdk` |
| Java SDK | Maven Central coordinate `io.github.mindburnlabs:helm-sdk:0.5.11` |
...
Release target: `v0.5.11`. The release is complete only after the tagged
...
<https://github.com/Mindburn-Labs/helm-ai-kernel/releases/tag/v0.5.11>.
...
`helm-ai-kernel.rb` formula asset for version `0.5.11` and publishes the same
...
For `v0.5.10`, use `SHA256SUMS.txt`, `sbom.json`, `v0.5.11.openvex.json`,
