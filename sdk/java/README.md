...
`io.github.mindburnlabs:helm-sdk:0.5.13`. Remote Maven resolution and repo1
...
`0.5.13` is the release-hardening patch with the retained OpenAPI client surface
