...
| Python SDK | `helm-sdk` |
| Rust SDK | `helm-sdk` |
| Java SDK | Maven Central coordinate `io.github.mindburnlabs:helm-sdk:0.7.4` |
| Go SDK | `github.com/Mindburn-Labs/helm-ai-kernel/sdk/go@v0.7.4`; publish with the subdirectory tag `sdk/go/v0.7.4` |
...
- Go SDK subdirectory tag publication for `sdk/go/v0.7.4`
...
Release target: `v0.7.4`. The release is complete only after the tagged
...
<https://github.com/Mindburn-Labs/helm-ai-kernel/releases/tag/v0.7.4>.
...
The retained release workflow attaches a `helm-ai-kernel.rb` formula asset for version `0.7.4`
...
`v0.7.4.openvex.json`, `release-attestation.json`, the platform binary assets,
