...
`helm-ai-kernel-launchpad-data.tar`, `helm-console-web-v0.5.16.tar.gz`,
its checksum/SBOM/provenance/lock/manifest sidecars, `helm-ai-kernel.mcpb`,
`helm-ai-kernel.rb`, `v0.5.16.json`, `version-status.json`, and matching
...
The `v0.5.16` release is complete only when it attaches these primary assets:
