...
func RuntimeRouteSpecs() []RuntimeRouteSpec {
	return []RuntimeRouteSpec{
		...
		{Method: http.MethodPost, Path: "/api/v1/gui/receipts/verify", MuxPattern: "/api/v1/gui/receipts/verify", Auth: RouteAuthTenant, RateLimit: RouteRateEvidence, ContractStatus: RouteContractPublic, OperationID: "verifyGUIActionReceipt", Owner: "core/cmd/helm-ai-kernel"},
