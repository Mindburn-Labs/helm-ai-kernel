...
<https://github.com/Mindburn-Labs/helm-ai-kernel/releases/tag/v0.7.0>. The
release is complete only when GitHub shows Darwin/Linux/Windows binaries,
`SHA256SUMS.txt`, `sbom.json`, `v0.7.0.openvex.json`,
...
`helm-ai-kernel.mcpb`, `helm-ai-kernel.rb`, `v0.7.0.json`,
