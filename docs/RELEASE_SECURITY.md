...
<https://github.com/Mindburn-Labs/helm-ai-kernel/releases/tag/v0.9.0>. The
release is complete only when GitHub shows Darwin/Linux/Windows binaries,
`SHA256SUMS.txt`, `sbom.json`,
`v0.9.0.openvex.json`, `release-attestation.json`, `evidence-pack.tar`,
...
`v0.9.0.json`, `version-status.json`, and matching `*.cosign.bundle` files for
