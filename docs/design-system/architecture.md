...
HELM AI Kernel ships one product frontend and one design-system package:

- `apps/console` is the single self-hostable HELM AI Kernel Console.
...
Commercial HELM applications may mirror or consume this package, but `helm-ai-kernel` does not contain HELM product-pattern packages, workbench apps, or starter apps.
