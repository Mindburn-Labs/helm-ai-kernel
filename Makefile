...
verify-connector-release-authority-vectors:
	cd core && go test ./pkg/registry/connectors -run TestConnectorReleaseAuthorityReferencePackMatchesGoImplementation -count=1
