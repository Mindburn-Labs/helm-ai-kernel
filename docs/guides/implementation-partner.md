...
This guide packages the local, self-hosted HELM AI Kernel v0.8.5 source target for an
...
The expected source release target for this packet is `0.8.5`. This is not a
...
[v0.8.5 release](https://github.com/Mindburn-Labs/helm-ai-kernel/releases/tag/v0.8.5).
