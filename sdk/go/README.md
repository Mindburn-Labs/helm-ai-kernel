...
Version truth is the repository `VERSION` file (`0.5.8` for this release).
...
`0.5.8` is the release-hardening patch with the public HTTP client surface, conformance entrypoints, and evidence verification helpers.
