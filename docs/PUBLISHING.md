...
| Python SDK | `helm-sdk` |
| Rust SDK | `helm-sdk` |
| Java SDK | Maven Central coordinate `io.github.mindburnlabs:helm-sdk:0.8.1` |
| Go SDK | `github.com/Mindburn-Labs/helm-ai-kernel/sdk/go@v0.8.1`; publish with the subdirectory tag `sdk/go/v0.8.1` |
...
- Go SDK subdirectory tag publication for `sdk/go/v0.8.1`
...
Release target: `v0.8.1`. The release is complete only after the tagged
...
<https://github.com/Mindburn-Labs/helm-ai-kernel/releases/tag/v0.8.1>.
...
The retained release workflow attaches a `helm-ai-kernel.rb` formula asset for version `0.8.1`
...
`v0.8.1.openvex.json`, `release-attestation.json`, the platform binary assets,
