...
func TestWorkloadKindsAndRelationshipsAreProviderExtensible(t *testing.T) {
	graph := contracts.LaunchWorkloadGraph{
		...
		SourceCommitSHA: strings.Repeat("c", 40), SourceTreeHash: launchHash("1"), UnknownSetHash: launchHash("2"),
		Nodes: []contracts.LaunchWorkloadNode{
			{NodeID: "engine", Kind: "acme.state-machine", LifecycleClass: contracts.LaunchLifecycleStatefulResource, DefinitionHash: launchHash("3"), RequirementsHash: launchHash("4"), RequiredCapabilities: []string{"acme-snapshot"}, Deployability: contracts.LaunchAnalysisSupported},
			{NodeID: "replica", Kind: "acme.state-machine", LifecycleClass: contracts.LaunchLifecycleStatefulResource, DefinitionHash: launchHash("5"), RequirementsHash: launchHash("6"), RequiredCapabilities: []string{"acme-replication"}, Deployability: contracts.LaunchAnalysisSupported},
		},
...
func TestRouteRecomputesEveryApprovalBoundArtifact(t *testing.T) {
	...
	for name, mutate := range map[string]func(*launchRouteFixture){
		"analysis hash":        func(f *launchRouteFixture) { f.route.RepositoryAnalysisHash = launchHash("9") },
		"quote hash":           func(f *launchRouteFixture) { f.route.RouteQuoteHash = launchHash("9") },
		"resource hash":        func(f *launchRouteFixture) { f.route.ResourceGraphHash = launchHash("9") },
		"payload set hash":     func(f *launchRouteFixture) { f.route.ProviderPayloadSetHash = launchHash("9") },
		"GeneratedSpec source": func(f *launchRouteFixture) { f.resolver.generated[f.route.GeneratedSpecRef] = launchHash("9") },
		"resolved quote": func(f *launchRouteFixture) {
			q := f.quote
			q.CommercialEvidenceHash = launchHash("9")
		...
		"quote price evidence outside certified profile": func(f *launchRouteFixture) {
			...
			q.PlacementCosts[0].PriceEvidenceHash = launchHash("9")
		...
		"resolved offer": func(f *launchRouteFixture) {
			offer := f.offer
			offer.ContentVersionHash = launchHash("9")
...
func TestOfferSnapshotNeverPromotesAdvisoryCreditToCashReduction(t *testing.T) {
	active := launchOfferSnapshot("cloud", "offer-active", "account:1", launchHash("1"), launchHash("2"), contracts.LaunchCreditVerified, 500)
...
func TestProviderCertificationRequiresSignatureTrustAndCurrentRegistryState(t *testing.T) {
	...
	fixture.resolver.current[fixture.certification.CertificationID] = launchHash("9")
...
func singleLaunchRouteFixture(t *testing.T, profile contracts.LaunchProviderCapabilityProfile, certified bool) launchRouteFixture {
	...
	resources := contracts.LaunchResourceGraph{
		...
		Nodes: []contracts.LaunchResourceNode{{ResourceID: "resource-api", PlacementID: "placement-1", WorkloadNodeID: "api", ResourceKind: "service", LifecycleClass: contracts.LaunchLifecycleEphemeral, DesiredStateHash: launchHash("2"), OwnershipTagHash: launchHash("3")}},
		Edges: []contracts.LaunchResourceEdge{},
	}
	offer := launchOfferSnapshot(profile.ProviderID, "offer-snapshot-1", "account:1", launchHash("1"), profile.TermsEvidenceHash, contracts.LaunchCreditVerified, 200)
	...
	payloads := contracts.LaunchProviderPayloadSet{
		...
		Entries: []contracts.LaunchProviderPayloadEntry{
			{PlacementID: "placement-1", EffectID: contracts.EffectTypeDeployProductionActivate, ProviderActionURN: profile.Actions[0].ActionURN, PayloadHash: launchHash("7")},
			{PlacementID: "placement-1", EffectID: contracts.EffectTypeProviderProvision, ProviderActionURN: profile.Actions[1].ActionURN, PayloadHash: launchHash("8")},
			{PlacementID: "placement-1", EffectID: contracts.EffectTypeProviderRollback, ProviderActionURN: profile.Actions[2].ActionURN, PayloadHash: launchHash("9")},
			{PlacementID: "placement-1", EffectID: contracts.EffectTypeProviderTeardown, ProviderActionURN: profile.Actions[3].ActionURN, PayloadHash: launchHash("a")},
		},
	}
	quote := contracts.LaunchRouteQuote{
		...
		PlacementCosts:        []contracts.LaunchPlacementCost{{PlacementID: "placement-1", ProviderID: profile.ProviderID, ProviderAccountHash: launchHash("1"), RegionID: region.RegionID, OfferingID: offering.OfferingID, BillingCadence: "monthly", CommitmentTerm: "monthly", BaseCostMinor: 1000, TaxFXReserveMinor: 200, GrossExposureMinor: 1200, VerifiedCreditMinor: 200, ExpectedCashMinor: 1000, CreditStatus: contracts.LaunchCreditVerified, OfferSnapshotRef: offer.SnapshotID, OfferSnapshotHash: offerHash, PriceEvidenceHash: profile.PricingEvidenceHash, TermsEvidenceHash: profile.TermsEvidenceHash}},
		BaseProviderCostMinor: 1000, TaxFXReserveMinor: 200, GrossExposureMinor: 1200, VerifiedCreditMinor: 200, ExpectedCashMinor: 1000,
		CreditStatus: contracts.LaunchCreditVerified, FXSnapshotHash: launchHash("5"), TaxSnapshotHash: launchHash("6"), CommercialEvidenceHash: launchHash("a"),
	...
	placement := contracts.LaunchRoutePlacement{
		...
		ProviderID: profile.ProviderID, ProviderAccountRef: "account:1", ProviderAccountHash: launchHash("1"), RegionID: region.RegionID, Jurisdiction: region.Jurisdiction, OfferingID: offering.OfferingID,
		...
		ActionBindings: []contracts.LaunchRouteActionBinding{
			...
			{EffectID: contracts.EffectTypeProviderRollback, ProviderActionURN: profile.Actions[2].ActionURN, ProviderPayloadHash: launchHash("9")},
			{EffectID: contracts.EffectTypeProviderTeardown, ProviderActionURN: profile.Actions[3].ActionURN, ProviderPayloadHash: launchHash("a")},
		},
	...
	if certified {
		...
		certification, _ = contracts.SignLaunchProviderCertificationRecord(contracts.LaunchProviderCertificationRecord{
			...
			CertificationTier: "provider-mutation-tier-1", CertificationSuiteHash: launchHash("b"), CertificationEvidenceHash: launchHash("c"), AdmissionStatus: contracts.LaunchProviderCertificationActive,
	...
	route := contracts.LaunchRouteBinding{
		...
		GeneratedSpecRef: "generated-spec-1", GeneratedSpecHash: launchHash("d"), Placements: []contracts.LaunchRoutePlacement{placement}, PlacementDependencies: []contracts.LaunchRouteDependency{},
...
func multiLaunchRouteFixture(t *testing.T) launchRouteFixture {
	...
	graph := contracts.LaunchWorkloadGraph{
		...
		Nodes: []contracts.LaunchWorkloadNode{
			{NodeID: "api", Kind: "http_service", LifecycleClass: contracts.LaunchLifecycleEphemeral, DefinitionHash: launchHash("3"), RequirementsHash: launchHash("4"), RequiredCapabilities: []string{"https-endpoint", "stateless-runtime"}, Deployability: contracts.LaunchAnalysisSupported},
			{NodeID: "database", Kind: "database", LifecycleClass: contracts.LaunchLifecycleStatefulData, DefinitionHash: launchHash("5"), RequirementsHash: launchHash("6"), RequiredCapabilities: []string{"managed-postgresql", "persistent-storage"}, Deployability: contracts.LaunchAnalysisSupported},
		},
	...
	resources := contracts.LaunchResourceGraph{
		...
		Nodes: []contracts.LaunchResourceNode{
			{ResourceID: "resource-api", PlacementID: "placement-a", WorkloadNodeID: "api", ResourceKind: "service", LifecycleClass: contracts.LaunchLifecycleEphemeral, DesiredStateHash: launchHash("7"), OwnershipTagHash: launchHash("8")},
			{ResourceID: "resource-db", PlacementID: "placement-b", WorkloadNodeID: "database", ResourceKind: "managed-database", LifecycleClass: contracts.LaunchLifecycleStatefulData, DesiredStateHash: launchHash("9"), OwnershipTagHash: launchHash("a")},
		},
	...
	payloads := contracts.LaunchProviderPayloadSet{
		...
		Entries: []contracts.LaunchProviderPayloadEntry{
			{PlacementID: "placement-a", EffectID: contracts.EffectTypeDeployProductionActivate, ProviderActionURN: webProfile.Actions[0].ActionURN, PayloadHash: launchHash("b")},
			{PlacementID: "placement-a", EffectID: contracts.EffectTypeProviderProvision, ProviderActionURN: webProfile.Actions[1].ActionURN, PayloadHash: launchHash("c")},
			{PlacementID: "placement-b", EffectID: contracts.EffectTypeDeployProductionActivate, ProviderActionURN: dbProfile.Actions[0].ActionURN, PayloadHash: launchHash("d")},
			{PlacementID: "placement-b", EffectID: contracts.EffectTypeProviderProvision, ProviderActionURN: dbProfile.Actions[1].ActionURN, PayloadHash: launchHash("e")},
		},
	}
	...
	placements := []contracts.LaunchRoutePlacement{
		{PlacementID: "placement-a", WorkloadNodeIDs: []string{"api"}, ProviderProfileRef: webProfile.ProfileID, ProviderProfileHash: webProfileHash, ProviderID: webProfile.ProviderID, ProviderAccountRef: "account:web", ProviderAccountHash: launchHash("1"), RegionID: "eu-edge", Jurisdiction: "EU", OfferingID: "app", ProviderConnectorID: webProfile.ConnectorID, ProviderConnectorContractHash: webProfile.ConnectorContractHash, ActionBindings: []contracts.LaunchRouteActionBinding{{EffectID: contracts.EffectTypeDeployProductionActivate, ProviderActionURN: webProfile.Actions[0].ActionURN, ProviderPayloadHash: launchHash("b")}, {EffectID: contracts.EffectTypeProviderProvision, ProviderActionURN: webProfile.Actions[1].ActionURN, ProviderPayloadHash: launchHash("c")}}, ResourceSubsetHash: webResourceHash, ProviderPayloadSubsetHash: webPayloadHash},
		{PlacementID: "placement-b", WorkloadNodeIDs: []string{"database"}, ProviderProfileRef: dbProfile.ProfileID, ProviderProfileHash: dbProfileHash, ProviderID: dbProfile.ProviderID, ProviderAccountRef: "account:data", ProviderAccountHash: launchHash("2"), RegionID: "eu-data", Jurisdiction: "EU", OfferingID: "postgres", ProviderConnectorID: dbProfile.ConnectorID, ProviderConnectorContractHash: dbProfile.ConnectorContractHash, ActionBindings: []contracts.LaunchRouteActionBinding{{EffectID: contracts.EffectTypeDeployProductionActivate, ProviderActionURN: dbProfile.Actions[0].ActionURN, ProviderPayloadHash: launchHash("d")}, {EffectID: contracts.EffectTypeProviderProvision, ProviderActionURN: dbProfile.Actions[1].ActionURN, ProviderPayloadHash: launchHash("e")}}, ResourceSubsetHash: dbResourceHash, ProviderPayloadSubsetHash: dbPayloadHash},
	}
	edgeHash, _ := contracts.DeriveLaunchWorkloadEdgeHash(graph.Edges[0])
	webOffer := launchOfferSnapshot(webProfile.ProviderID, "offer-edge", "account:web", launchHash("1"), webProfile.TermsEvidenceHash, contracts.LaunchCreditNone, 0)
	dbOffer := launchOfferSnapshot(dbProfile.ProviderID, "offer-data", "account:data", launchHash("2"), dbProfile.TermsEvidenceHash, contracts.LaunchCreditNone, 0)
	...
	quote := contracts.LaunchRouteQuote{
		...
		FXSnapshotHash: launchHash("4"), TaxSnapshotHash: launchHash("5"), CommercialEvidenceHash: launchHash("6"), RetrievedAt: "2026-07-19T00:00:00Z", ExpiresAt: "2026-07-19T12:00:00Z",
	}
	quote.CreditSnapshotHash, _ = contracts.DeriveLaunchOfferSnapshotSetHash(quote.PlacementCosts)
	analysisHash, _ := contracts.DeriveLaunchRepositoryAnalysisHash(analysis)
	quoteHash, _ := contracts.DeriveLaunchRouteQuoteHash(quote)
...
func launchHTTPWorkloadGraph() contracts.LaunchWorkloadGraph {
	return contracts.LaunchWorkloadGraph{
		...
		Nodes: []contracts.LaunchWorkloadNode{{NodeID: "api", Kind: "http_service", LifecycleClass: contracts.LaunchLifecycleEphemeral, DefinitionHash: launchHash("3"), RequirementsHash: launchHash("4"), RequiredCapabilities: []string{"health-check", "https-endpoint", "stateless-runtime"}, Deployability: contracts.LaunchAnalysisSupported}},
...
func launchOfferSnapshot(providerID, snapshotID, accountRef, accountHash, termsHash, status string, verifiedCredit int64) contracts.LaunchOfferSnapshot {
	return contracts.LaunchOfferSnapshot{
		...
		OfficialSourceURL: "https://example.invalid/" + providerID + "/official-offers", ContentVersionHash: launchHash("c"), TermsHash: termsHash, ExclusionsHash: launchHash("d"),
...
func launchProviderProfile(provider, connector, region, offering string, workloads, capabilities, lifecycles []string, urnPrefix string) contracts.LaunchProviderCapabilityProfile {
	return contracts.LaunchProviderCapabilityProfile{
		SchemaVersion: contracts.LaunchProviderProfileSchemaVersion, ProfileID: provider + "-candidate", ProviderID: provider, ConnectorID: connector, ConnectorContractHash: launchHash("d"), ProfileVersion: "candidate-1", ProfileStatus: contracts.LaunchProviderProfileCandidate,
		...
		PricingEvidenceRef: "fixture://" + provider + "/pricing", PricingEvidenceHash: launchHash("a"), TermsEvidenceRef: "fixture://" + provider + "/terms", TermsEvidenceHash: launchHash("b"), RetrievedAt: "2026-07-19T00:00:00Z", ExpiresAt: "2026-07-20T00:00:00Z",
	}
}
