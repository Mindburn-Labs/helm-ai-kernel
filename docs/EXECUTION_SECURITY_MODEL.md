...
Use this page when you need the public `helm-oss/execution-security-model` guidance without opening repo internals first. It is written for developers, operators, security reviewers, and evaluators who need to connect the docs website back to the owning HELM source files.
...
- Public route: `helm-oss/execution-security-model`
- Source document: `helm-oss/docs/EXECUTION_SECURITY_MODEL.md`
