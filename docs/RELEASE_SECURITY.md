...
flowchart LR
  ...
  ci --> sbom["SBOM"]
  ci --> attestation["Release attestation"]
...
| SBOM and release attestation | `release/README.md`, `scripts/ci/generate_sbom.sh`, release asset `sbom.json`, release asset `release-attestation.json` | This page |
...
downloaded from a release page. Verify checksums, release attestation,
