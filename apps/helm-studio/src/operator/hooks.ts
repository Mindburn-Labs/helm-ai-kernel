...
export function useWorkspace(workspaceId: string) {
  return useQuery({
    ...
    queryFn: async (): Promise<WorkspaceContext | null> => {
      try {
        return await studioApi.getWorkspace(workspaceId);
      } catch (error) {
        if (isNotFound(error)) {
...
export function useRuns(workspaceId: string) {
  return useQuery({
    ...
    enabled: Boolean(workspaceId),
    queryFn: () => studioApi.listRuns(workspaceId),
  });
}
...
export function useRun(workspaceId: string, runId: string) {
  return useQuery({
    ...
    queryFn: async (): Promise<RunRecord | null> => {
      try {
        return await studioApi.getRun(workspaceId, runId);
      } catch (error) {
        if (isNotFound(error)) {
          return null;
        }
...
export function useRunReceipts(workspaceId: string, runId: string) {
  return useQuery({
    ...
    enabled: Boolean(workspaceId && runId),
    queryFn: () => studioApi.listRunReceipts(workspaceId, runId),
  });
}
...
export function useApprovals(workspaceId: string) {
  return useQuery({
    ...
    enabled: Boolean(workspaceId),
    queryFn: () => studioApi.listApprovals(workspaceId),
  });
}
...
export function useApproval(workspaceId: string, approvalId: string) {
  return useQuery({
    ...
    queryFn: async (): Promise<ApprovalRecord | null> => {
      try {
        return await studioApi.getApproval(workspaceId, approvalId);
      } catch (error) {
        if (isNotFound(error)) {
          return null;
        }
...
export function useGraphs(workspaceId: string) {
  return useQuery({
    ...
    enabled: Boolean(workspaceId),
    queryFn: () => studioApi.listToolSurfaces(workspaceId),
  });
}
...
export function useActivePolicy(workspaceId: string) {
  return useQuery({
    ...
    queryFn: async (): Promise<PolicyVersion | null> => {
      try {
        return await studioApi.getActivePolicy(workspaceId);
      } catch (error) {
        if (isNotFound(error)) {
          return null;
        }
...
export function useSimulations(workspaceId: string) {
  return useQuery({
    ...
    enabled: Boolean(workspaceId),
    queryFn: () => studioApi.listSimulations(workspaceId),
  });
}
...
export function useReplays(workspaceId: string) {
  return useQuery({
    ...
    queryFn: async (): Promise<ReplayManifest[]> => {
      const replays = await studioApi.listPublicReplays();
...
export function useCreateWorkspace() {
  ...
  return useMutation({
    mutationFn: async (input: {
      ...
      const workspace = await studioApi.createWorkspace({
        name: input.name,
        mode: input.mode,
...
export function useCompilePolicy(workspaceId: string) {
  return useMutation({
    mutationFn: (draftId: string) => studioApi.compilePolicy(workspaceId, draftId),
  });
}
...
export function useActivatePolicy(workspaceId: string) {
  ...
  return useMutation({
    mutationFn: (versionId: string) => studioApi.activatePolicy(workspaceId, versionId),
    onSuccess: async () => {
...
export function useGenerateExport(workspaceId: string) {
  return useMutation({
    mutationFn: () => studioApi.generateExport(workspaceId),
  });
}
...
export function useVerifyReceipt() {
  return useMutation({
    mutationFn: (receipt: NonNullable<RunRecord['receipts']>[number]) =>
      studioApi.verifyReceipt(receipt),
  });
}
...
export function useTasks(workspaceId: string) {
  return useQuery({
    ...
    enabled: Boolean(workspaceId),
    queryFn: () => studioApi.listTasks(workspaceId),
  });
}
...
export function usePauseTask(workspaceId: string) {
  ...
  return useMutation({
    mutationFn: (taskId: string) => studioApi.pauseTask(workspaceId, taskId),
    onSuccess: () => {
      void queryClient.invalidateQueries({ queryKey: keys.tasks(workspaceId) });
    },
  });
...
export function useResumeTask(workspaceId: string) {
  ...
  return useMutation({
    mutationFn: (taskId: string) => studioApi.resumeTask(workspaceId, taskId),
    onSuccess: () => {
      void queryClient.invalidateQueries({ queryKey: keys.tasks(workspaceId) });
    },
  });
...
export function useCancelTask(workspaceId: string) {
  ...
  return useMutation({
    mutationFn: (taskId: string) => studioApi.cancelTask(workspaceId, taskId),
    onSuccess: async () => {
