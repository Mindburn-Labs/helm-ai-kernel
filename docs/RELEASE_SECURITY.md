...
<https://github.com/Mindburn-Labs/helm-ai-kernel/releases/tag/v0.8.3>. The
release is complete only when GitHub shows Darwin/Linux/Windows binaries,
`SHA256SUMS.txt`, `sbom.json`, `v0.8.3.openvex.json`,
...
`helm-ai-kernel.mcpb`, `helm-ai-kernel.rb`, `v0.8.3.json`,
