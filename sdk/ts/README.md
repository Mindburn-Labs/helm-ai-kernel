...
Package metadata declares version `0.5.7` in `package.json`; this README does
...
`0.5.7` is the release-hardening patch with the retained OpenAPI client surface and protobuf message bindings.
