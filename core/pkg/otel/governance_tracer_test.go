...
func TestTraceDecisionEmitsGenAIKeys(t *testing.T) {
	...
	expected := map[string]string{
		...
		observability.GenAIRequestModel: "gpt-6-sol",
		...
		observability.GenAIResponseModel:        "gpt-6-sol",
...
func TestTraceDenialEmitsGenAIKeys(t *testing.T) {
	...
	tracer.TraceDenial(ctx, DenialEvent{
		...
		GenAIRequestModel:  "claude-sonnet-5",
		GenAIOperationName: observability.GenAIOperationToolCall,
	...
	expected := map[string]string{
		...
		observability.GenAIRequestModel:  "claude-sonnet-5",
		observability.GenAIOperationName: "execute_tool",
