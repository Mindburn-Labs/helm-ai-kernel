...
Package metadata declares crate version `0.5.13` in `Cargo.toml`; verify registry
...
`0.5.13` is the release-hardening patch with the retained OpenAPI client surface and optional protobuf codegen.
