...
//
// When `token == ""`, methods return the same sentinel error shape they did
// as a stub ("not connected: requires personal access token"). This preserves
// the connector_test.go suite which constructs Client without a token.
//
...
//
// Roadmap: P2-01 (real connector set: GitHub + Slack + Linear).
package github
