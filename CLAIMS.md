...
- Canonical role: Public HELM AI Kernel implementation: fail-closed execution kernel, CLI/API, SDK/contracts, receipts, replay/conformance surfaces, and self-hostable console.
