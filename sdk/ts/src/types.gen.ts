...
export interface DecisionRequest {
     ...
     * @memberof DecisionRequest
     */
    session_history?: Array<SessionAction>;
}
...
export function DecisionRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): DecisionRequest {
    ...
    return {
        ...
        'session_history': json['session_history'] == null ? undefined : ((json['session_history'] as Array<any>).map(SessionActionFromJSON)),
    };
}
...
export function DecisionRequestToJSON(value?: DecisionRequest | null): any {
    ...
    return {
        ...
        'session_history': value['session_history'] == null ? undefined : ((value['session_history'] as Array<any>).map(SessionActionToJSON)),
    };
}
...
export interface SessionAction {
     ...
     * @memberof SessionAction
     */
    verdict: SessionActionVerdictEnum;
    /**
 ...
 * @export
 */
export const SessionActionVerdictEnum = {
    Allow: 'ALLOW',
    Deny: 'DENY',
    Escalate: 'ESCALATE'
} as const;
export type SessionActionVerdictEnum = typeof SessionActionVerdictEnum[keyof typeof SessionActionVerdictEnum];


/**
 * Check if a given object implements the SessionAction interface.
 */
export function instanceOfSessionAction(value: object): boolean {
    if (!('action' in value)) return false;
    if (!('resource' in value)) return false;
    if (!('verdict' in value)) return false;
...
export function SessionActionFromJSON(json: any): SessionAction {
    return SessionActionFromJSONTyped(json, false);
}

export function SessionActionFromJSONTyped(json: any, ignoreDiscriminator: boolean): SessionAction {
    if (json == null) {
        return json;
    }
    return {
...
export function SessionActionToJSON(value?: SessionAction | null): any {
    if (value == null) {
        return value;
    }
    return {
