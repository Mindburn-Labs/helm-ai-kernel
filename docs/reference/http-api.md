...
| Evidence | `POST /api/v1/evidence/export`, `POST /api/v1/evidence/verify`, `GET|POST /api/v1/evidence/envelopes`, `GET /api/v1/evidence/envelopes/{manifest_id}`, `POST /api/v1/evidence/envelopes/{manifest_id}/verify` | [`contract_routes.go`](../../core/cmd/helm/contract_routes.go) |
| Boundary | `GET /api/v1/boundary/status`, `GET /api/v1/boundary/capabilities`, `GET /api/v1/boundary/records`, `GET /api/v1/boundary/records/{record_id}`, `POST /api/v1/boundary/records/{record_id}/verify`, `GET|POST /api/v1/boundary/checkpoints` | [`contract_routes.go`](../../core/cmd/helm/contract_routes.go), [`core/pkg/boundary`](../../core/pkg/boundary) |
...
- `GET /api/v1/receipts/tail` is an SSE stream and requires an agent query.
...
| SSE receipt tail does not stream | Include the required agent query and verify the runtime was started with receipt storage enabled. |
